...
// Map a library item onto the constitution's item shape — pure, shared with
// the composers via src/lib/house-item.ts; re-exported here for existing callers.
export { toHouseItem } from '@/lib/house-item'
