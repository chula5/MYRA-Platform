...
export default function ScoreInput({
  ...
  return (
    <div className="mb-5">
      <label className="text-[10px] tracking-[0.09em] text-[#6B6B6B] mb-1 block">
        {label}
      </label>
      {description && (
        <p className="text-[9px] tracking-[0.054em] text-[#A8A8A4] mb-2">{description}</p>
      )}
      <div className="flex items-center gap-2">
        ...
        {!required && (
          <button
            type="button"
            onClick={handleClear}
            className="ml-2 text-[9px] tracking-[0.068em] text-[#A8A8A4] hover:text-[#6B6B6B] transition-colors duration-300"
          >
