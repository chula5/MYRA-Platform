...
export const PICKER_COLOURS: { value: string; label: string; swatch: string }[] = [
  ...
  { value: 'yellow', label: 'YELLOW', swatch: '#e3c35a' },
  { value: 'orange', label: 'ORANGE', swatch: '#d9803a' },
  { value: 'purple', label: 'PURPLE', swatch: '#6e4a86' },
  { value: 'multicolour', label: 'MULTI', swatch: 'conic-gradient(#b3202a, #e3c35a, #3d6b45, #3565b0, #b3202a)' },
]

// Every ItemType in the library (src/types/database.ts), so no piece is ever
// unreachable by a type filter — the list used to stop at 18, with no chip for
// shirts, blouses, tees, jeans, shorts, any dress, belts or scarves.
export const PICKER_TYPES: { value: string; label: string }[] = [
  ...
  { value: 'structured_bag', label: 'STRUCTURED BAG' },
  ...
  { value: 'hair_accessory', label: 'HAIR' },
  { value: 'hat', label: 'HAT' },
