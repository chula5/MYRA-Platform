  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white flex flex-col items-center justify-center px-10">
        ...
        <h1 className="text-[clamp(28px,4vw,52px)] tracking-[0.12em] text-[#4A4E57] mb-5 text-center">
          LAUNCHING SOON
        </h1>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <Link
            href="/"
            className="text-[10px] tracking-[0.25em] text-[#6B6B6B] hover:text-[#4A4E57] border border-[#E2E0DB] hover:border-[#0A0A0A] px-8 py-3 transition-colors duration-300"
          >
            ← BACK TO LOOKBOOK
          </Link>
        </div>
