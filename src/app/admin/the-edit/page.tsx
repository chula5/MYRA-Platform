  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <h1 className="text-[28px] tracking-[0.10em] text-[#4A4E57]">THE EDIT — PRIVATE PREVIEW</h1>
        ...
        <div className="flex flex-wrap gap-3 mt-4">
          <a
            ...
            className="inline-flex items-center gap-2 border border-[#0A0A0A] text-[#4A4E57] px-5 py-2.5 rounded-[3px] text-[10px] tracking-[0.20em] hover:bg-[#0A0A0A] hover:text-white transition-colors duration-300"
          >
            ▶ PREVIEW NEW-USER SIGN-UP FLOW
          </a>
          <a
            href="/admin/age-tagging"
            className="inline-flex items-center gap-2 border border-[#E2E0DB] text-[#6B6B6B] px-5 py-2.5 rounded-[3px] text-[10px] tracking-[0.20em] hover:border-[#0A0A0A] hover:text-[#4A4E57] transition-colors duration-300"
          >
            ⊕ AGE-TAG OUTFITS
          </a>
        </div>
      ...
      <div className="flex items-center justify-between gap-6 border border-[#E2E0DB] bg-white p-5 rounded-[3px] mb-8">
        <div>
          ...
          <p className="text-[15px] tracking-[0.10em] text-[#4A4E57]">
