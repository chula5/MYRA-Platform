  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-[22px] tracking-[0.10em] text-[#0A0A0A]">AGE-TAG OUTFITS</h1>
        <p className="text-[11px] tracking-[0.13em] text-[#6B6B6B] mt-2 max-w-[640px] leading-relaxed">
          Tag which age ranges each outfit suits. New users only see outfits matching the age they
          pick at sign-up. An outfit with <span className="text-[#0A0A0A]">no tags shows to everyone</span> —
